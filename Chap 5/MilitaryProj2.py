...
MIL_TIME = ["00:45", "15:10", "20:03", "HH,MM", "17:36", "09:48",
            "10:11", "XX:09", "11:09", "10:04", "04:20", "05:09", "!8:$4"]
...
for i in enumerate(MIL_TIME):
    ...
    if not(MIL_TIME[i[0]][0:2].isdigit()) or not(MIL_TIME[i[0]][3:5].isdigit()):
        del MIL_TIME[i[0]]
        deleted += 1
print("Deleted", deleted,"enteries for bad formating!")
